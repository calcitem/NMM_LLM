...
def _time_budget_for_level(level: int) -> float:
    """Midgame heuristic time budget (opponent).
...
def run(args: argparse.Namespace) -> None:
    ...
    print(f"[s_mid_v2] LookaheadAdvisor: 15-ply width, {args.sim_ply_depth}-ply sim, 4 signals (h+vn+sent+gap)")
    ...
    print(f"[s_mid_v2] feat_dim={MOVE_FEAT_DIM_WITH_TOPK}, starting game={start_game}, diff={difficulty}")
